    ...
    <div class="mt-3 grid gap-2 sm:grid-cols-2">
        <x-forms.legacy-field label="Room">
            <div class="flex gap-1">
                <x-forms.legacy-input placeholder="No. Room" />
                <button type="button" class="mini-button" data-open-dialog="reservationFolioLookupModal"><i data-lucide="search" class="h-3 w-3"></i></button>
            </div>
        </x-forms.legacy-field>
        <x-forms.legacy-field label="Name"><x-forms.legacy-input placeholder="Nama tamu" /></x-forms.legacy-field>
