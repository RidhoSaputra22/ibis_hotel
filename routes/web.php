...
use App\Http\Controllers\RestaurantTransactionController;
...
Route::middleware('cashier.session')->group(function (): void {
    ...
    Route::get('/restaurant-transaction', [RestaurantTransactionController::class, 'transaction'])->name('restaurant.transaction');
    Route::get('/table-list', [RestaurantTransactionController::class, 'tableList'])->name('restaurant.table-list');
